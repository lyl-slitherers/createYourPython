...
###
        while (cont8):
            ...
            if (a == "1"):
                ...
                asteroid5 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .25*SPE]
                asteroid6 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .55*SPE]
                asteroid7 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .85*SPE]
                asteroid8 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .95*SPE]
                asteroid11 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .2*SPE]
                asteroid21 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .5*SPE]
                asteroid31 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .8*SPE]
                asteroid41 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .9*SPE]
                asteroid51 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .25*SPE]
                asteroid61 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .55*SPE]
                asteroid71 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .85*SPE]
                asteroid81 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .95*SPE]
                asteroid12 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .2*SPE]
                asteroid22 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .5*SPE]
                asteroid32 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .8*SPE]
                asteroid42 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .9*SPE]
                asteroid52 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .25*SPE]
                asteroid62 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .55*SPE]
                asteroid72 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .85*SPE]
                asteroid82 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .95*SPE]
                asteroid13 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .2*SPE]
                asteroid23 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .5*SPE]
                asteroid33 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .8*SPE]
                asteroid43 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .9*SPE]
                asteroid53 = [random.randint(0, width-75), random.randint(0, height-75), 60, math.pi * random.randint(1, 10) / random.randint(1, 10), .25*SPE]
                asteroid63 = [random.randint(0, width-75), random.randint(0, height-75), 40, math.pi * random.randint(1, 10) / random.randint(1, 10), .55*SPE]
                asteroid73 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .85*SPE]
                asteroid83 = [random.randint(0, width-75), random.randint(0, height-75), 20, math.pi * random.randint(1, 10) / random.randint(1, 9), .95*SPE]
